...
import SliderThumb from "../../SliderThumb"; // plasmic-import: 9Ts2PxR6U7gl/component
...
import sty from "./PlasmicRangeSlider.module.css"; // plasmic-import: y9ylQCfWnudx/css
...
function PlasmicRangeSlider__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__ezMgf)}>
        {$props.showLabel ? (
          <Label
      ...
      <div className={classNames(projectcss.all, sty.freeBox__vpFo)}>
        <div
