...
import sty from "./PlasmicSlider.module.css"; // plasmic-import: DsIAYVmGBCx8/css
  ...
  return (
    ...
    >
      {$props.showLabel || $props.showOutputText ? (
        <div className={classNames(projectcss.all, sty.freeBox__iQvzR)}>
          {$props.showLabel ? (
            <Label
      ...
      <div className={classNames(projectcss.all, sty.freeBox__jpIaV)}>
        <div
