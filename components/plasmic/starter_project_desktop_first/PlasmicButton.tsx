...
import { _useGlobalVariants } from "./plasmic"; // plasmic-import: hSmcsWKw3zCBXehRUPYvUE/projectModule
import { _useStyleTokens } from "./PlasmicStyleTokensProvider"; // plasmic-import: hSmcsWKw3zCBXehRUPYvUE/styleTokensProvider

import "@plasmicapp/react-web/lib/plasmic.css";

import projectcss from "./plasmic.module.css"; // plasmic-import: hSmcsWKw3zCBXehRUPYvUE/projectcss
import sty from "./PlasmicButton.module.css"; // plasmic-import: vDAMUW0R2wDV/css

import CircleIcon from "./icons/PlasmicIcon__Circle"; // plasmic-import: RK6KqOLqEZGM/icon
import ChevronDownIcon from "./icons/PlasmicIcon__ChevronDown"; // plasmic-import: OlYDLB3pwNVa/icon
...
function PlasmicButton__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__jCaTj, {
          [sty.freeBoxcolor_neutral__jCaTjjQwga]: hasVariant(
            $state,
            "color",
            "neutral"
          ),
          [sty.freeBoxcolor_success_type_bordered__jCaTjTqmx8R0AXi]:
            hasVariant($state, "color", "success") &&
            hasVariant($state, "type", "bordered"),
          [sty.freeBoxroundedFull__jCaTj2OcPy]: hasVariant(
            $state,
            "roundedFull",
            "roundedFull"
          ),
          [sty.freeBoxsize_extraLarge__jCaTjx0Klr]: hasVariant(
            $state,
            "size",
            "extraLarge"
          ),
          [sty.freeBoxsize_extraSmall__jCaTjUog4V]: hasVariant(
            $state,
            "size",
            "extraSmall"
          ),
          [sty.freeBoxsize_large__jCaTjotcLe]: hasVariant(
            $state,
            "size",
            "large"
          ),
          [sty.freeBoxsize_small__jCaTjIxnVe]: hasVariant(
            $state,
            "size",
            "small"
          ),
          [sty.freeBoxtype_bordered__jCaTjr0AXi]: hasVariant(
            $state,
            "type",
            "bordered"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__lPmP, {
            [sty.freeBoxcolor_neutral__lPmPjQwga]: hasVariant(
              $state,
              "color",
              "neutral"
            ),
            [sty.freeBoxiconStart__lPmPfZu09]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxsize_extraLarge__lPmPx0Klr]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__lPmPotcLe]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__lPmPIxnVe]: hasVariant(
              $state,
              "size",
              "small"
            ),
            [sty.freeBoxtype_bordered__lPmPr0AXi]: hasVariant(
              $state,
              "type",
              "bordered"
            ),
            [sty.freeBoxtype_soft_color_neutral__lPmPnb55JJQwga]:
              hasVariant($state, "color", "neutral") &&
              hasVariant($state, "type", "soft")
          })}
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__o74Yr)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__uenRb, {
            [sty.freeBoxiconEnd__uenRbdar5G]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxsize_extraLarge__uenRbx0Klr]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__uenRbotcLe]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__uenRbIxnVe]: hasVariant(
              $state,
              "size",
              "small"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChevronDownIcon
                className={classNames(projectcss.all, sty.svg__nYb6Y)}
                role={"img"}
              />
            ),
