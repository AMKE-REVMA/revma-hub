...
import sty from "./PlasmicOverlayArrow.module.css"; // plasmic-import: RShM0XkOJgI3/css

import TriangleFilledIcon from "./icons/PlasmicIcon__TriangleFilled"; // plasmic-import: OHolHNW6DZw4/icon
