...
import sty from "./PlasmicCheckbox.module.css"; // plasmic-import: 0pDLQfxNlXZr/css

import CheckIcon from "./icons/PlasmicIcon__Check"; // plasmic-import: tarOjlM9-PFa/icon
import MinusIcon from "./icons/PlasmicIcon__Minus"; // plasmic-import: 4PjagTFrrX7T/icon
    ...
    >
      ...
      >
        {(
          ...
          <CheckIcon
            className={classNames(projectcss.all, sty.svg__ziJbW)}
            role={"img"}
          />
        ) : null}
        {($ccVariants["indeterminate"] ? true : false) ? (
          <MinusIcon
            className={classNames(projectcss.all, sty.svg__uzV)}
            role={"img"}
          />
        ) : null}
      </div>
