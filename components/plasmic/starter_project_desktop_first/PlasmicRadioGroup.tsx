...
import Radio from "../../Radio"; // plasmic-import: J4Lt1BQV38fX/component
...
import sty from "./PlasmicRadioGroup.module.css"; // plasmic-import: 6G-0oOFtmgHU/css
...
function PlasmicRadioGroup__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      {renderPlasmicSlot({
        defaultContents: (
          <div className={classNames(projectcss.all, sty.freeBox__bcmYc)}>
            <Radio
              className={classNames("__wab_instance", sty.radio__k8KZ9)}
              label={"Option 1"}
              value={"option1"}
            />

            <Radio
              className={classNames("__wab_instance", sty.radio__sprUm)}
              label={"Option 2"}
              value={"option2"}
            />

            <Radio
              className={classNames("__wab_instance", sty.radio__rb5Ze)}
              label={"Option 3"}
              value={"option3"}
            />
          </div>
