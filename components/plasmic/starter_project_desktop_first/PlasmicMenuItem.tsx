...
import sty from "./PlasmicMenuItem.module.css"; // plasmic-import: rHP7TLAg0t80/css
...
function PlasmicMenuItem__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__pumw6)}>
        <BaseText
          ...
          slot={"label"}
        >
          <div className={classNames(projectcss.all, sty.freeBox__th52B)}>
            <div
              className={classNames(
                projectcss.all,
