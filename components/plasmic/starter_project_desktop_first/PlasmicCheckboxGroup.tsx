...
import Checkbox from "../../Checkbox"; // plasmic-import: 0pDLQfxNlXZr/component
...
import sty from "./PlasmicCheckboxGroup.module.css"; // plasmic-import: _7Mnf9BoSAil/css
...
function PlasmicCheckboxGroup__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      {renderPlasmicSlot({
        defaultContents: (
          <div className={classNames(projectcss.all, sty.freeBox__ivJ6)}>
            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__ve424)}
              label={"Option 1"}
              value={"option1"}
            />

            <Checkbox
              className={classNames("__wab_instance", sty.checkbox__xQiW)}
              label={"Option 2"}
              value={"option2"}
            />

            <Checkbox
              className={classNames("__wab_instance", sty.checkbox___73DAu)}
              label={"Option 3"}
              value={"option3"}
            />
          </div>
