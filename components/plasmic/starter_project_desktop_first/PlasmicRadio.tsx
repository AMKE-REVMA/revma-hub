...
import sty from "./PlasmicRadio.module.css"; // plasmic-import: J4Lt1BQV38fX/css
...
function PlasmicRadio__RenderFunc(props: {
  ...
  return (
    <BaseRadio
      ...
      value={args.value}
    >
      <div className={classNames(projectcss.all, sty.freeBox__cT2YZ)}>
        <div className={classNames(projectcss.all, sty.freeBox__brbme)} />
      </div>
      {renderPlasmicSlot({
