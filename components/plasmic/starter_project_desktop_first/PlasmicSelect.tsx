...
import MenuPopover from "../../MenuPopover"; // plasmic-import: bPJmod3q2AES/component
import MenuItem from "../../MenuItem"; // plasmic-import: rHP7TLAg0t80/component
import MenuSection from "../../MenuSection"; // plasmic-import: 1ApjIHtHpAYt/component
...
import sty from "./PlasmicSelect.module.css"; // plasmic-import: dtVYT5zw-7T0/css
        ...
        menuItems={renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              ...
              <MenuSection
                className={classNames("__wab_instance", sty.menuSection__vtkbu)}
                header={
                  <div
                    className={classNames(
                      projectcss.all,
