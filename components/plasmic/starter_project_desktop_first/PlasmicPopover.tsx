...
import OverlayArrow from "../../OverlayArrow"; // plasmic-import: RShM0XkOJgI3/component
...
import sty from "./PlasmicPopover.module.css"; // plasmic-import: 1z5Wj0qV_I5S/css
  ...
  return (
    <BaseDialogTrigger
      ...
      dialog={
        ...
        >
          ...
          >
            {renderPlasmicSlot({
              defaultContents: (
                <div className={classNames(projectcss.all, sty.freeBox___0Ah7)}>
                  <div
                    className={classNames(
                      projectcss.all,
      ...
      trigger={renderPlasmicSlot({
        defaultContents: (
          <Button
            className={classNames("__wab_instance", sty.button__qkuNz)}
            label={"Open Popover"}
          />
        ),
