...
import Label from "../../Label"; // plasmic-import: xZKhor7eYNC8/component
import TextInput from "../../TextInput"; // plasmic-import: 42gx21VgEdwc/component
import TextAreaInput from "../../TextAreaInput"; // plasmic-import: MYtE7M4aHgcV/component
import Description from "../../Description"; // plasmic-import: Hqt8jpRfRIlF/component
...
import sty from "./PlasmicTextField.module.css"; // plasmic-import: aMIf-a2WxWlc/css
...
function PlasmicTextField__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__bq8Mw, {
          [sty.freeBoxiconEnd__bq8MWdCwVi]: hasVariant(
            $state,
            "iconEnd",
            "iconEnd"
          ),
          [sty.freeBoxiconStart__bq8Mw43BtU]: hasVariant(
            $state,
            "iconStart",
            "iconStart"
          ),
          [sty.freeBoxmultiLine__bq8Mwpu10]: hasVariant(
            $state,
            "multiLine",
            "multiLine"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__vOzf4, {
            [sty.freeBoxiconStart__vOzf443BtU]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxmultiLine__vOzf4Pu10]: hasVariant(
              $state,
              "multiLine",
              "multiLine"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__tFsyy)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__uYkb3, {
            [sty.freeBoxiconEnd__uYkb3DCwVi]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxiconStart__uYkb343BtU]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__jWdLd)}
                role={"img"}
              />
            ),
